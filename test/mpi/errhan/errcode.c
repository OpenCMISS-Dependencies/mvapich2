...
int main(int argc, char **argv)
{
    ...
    /* src/mpi/romio/adio/ad_piofs/ad_piofs_read.c */
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**cudaEventRecord", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**cudaEventRecord" );
    ...
    char s1[] = "string1";
     err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**fail", "%s", s1 );
    ChkMsg( err, MPI_ERR_OTHER, "%s" );
    }
    /* src/mpid/ch3/channels/mrail/src/rdma/ch3_contigsend.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**ch3|contigsend", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**ch3|contigsend" );
    ...
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**nem|packetizedsend", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**nem|packetizedsend" );
    /* src/mpid/ch3/channels/nemesis/netmod/ib/ib_send.c */
    err = MPIR_Err_create_code(MPI_SUCCESS, MPIR_ERR_RECOVERABLE, "errcode::main", __LINE__, MPI_ERR_OTHER, "**nem|ibeagersend", 0);
    ChkMsg( err, MPI_ERR_OTHER, "**nem|ibeagersend" );
