...
int MV2_set_allreduce_tuning_table(int heterogeneity)
{
  ...
  if (mv2_use_indexed_tuning || mv2_use_indexed_allreduce_tuning) {
	...
	MPIU_Memcpy(mv2_allreduce_indexed_thresholds_table[i], table_ptrs[i],
      ...
      mv2_allreduce_indexed_tuning_table mv2_tmp_cma_allreduce_indexed_thresholds_table_8ppn[] =
        GEN2_CMA__RI__8PPN;
      ...
      if (g_smp_use_cma) {
        ...
        table_ptrs[2] = mv2_tmp_cma_allreduce_indexed_thresholds_table_8ppn;
      }
      else {
        mv2_size_allreduce_indexed_tuning_table[2] = 8;
